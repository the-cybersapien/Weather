...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = mContext.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
                null, WeatherContract.LocationEntry.COLUMN_CITY_NAME + "=?",
                selectionArgs, null);
        if (cursor.getCount()==0){
            ...
            cursor.moveToFirst();
            id = cursor.getLong(cursor.getColumnIndex(WeatherContract.LocationEntry._ID));
        }
        return id;
    }
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (c.getCount()>0){
                String delete = WeatherEntry.COLUMN_DATE + "<?";
                long dateTime = dayTime.setJulianDay(julianStartDay);
                String[] deletedArgs = {
                        String.valueOf(dateTime)
                };
                deleted = mContext.getContentResolver().delete(WeatherEntry.CONTENT_URI, delete, deletedArgs);
            }
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                Log.d(LOG_TAG, String.valueOf(dateTime));
            ...
            Log.d(LOG_TAG, "FetchWeatherTask Complete. " + deleted + " Deleted");
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        Log.d(LOG_TAG, "onPreExecute: Starting Fetch Weather");
    }
}